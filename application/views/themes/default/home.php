        ...
        <div class="wide-banners wow fadeInUp outer-bottom-xs">
          <div class="row">
            ...
            <div class="col-md-7 col-sm-7">
              ...
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  <div class="slider-header fadeInDown-1"><?php echo ucwords($banners[0]['title']); ?></div>
                  <div class="big-text fadeInDown-1"> <?php echo ucwords($banners[0]['sub_title']); ?></div>
                  <div class="excerpt fadeInDown-2 hidden-xs"> <span><?php echo ucwords($banners[0]['description']); ?></span> </div>
                  <div class="button-holder fadeInDown-3"> <a href="#<?php echo base_url(); ?>index.php?page=single-product" class="btn-lg btn btn-uppercase btn-primary shop-now-button">Shop Now</a> </div>
                </div>
                <!-- /.caption -->
              </div>
