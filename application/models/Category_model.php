 ...
 */
	...
	/**
	 * [get categories which is not contain subcategories description]
	 * @param  [type]  [description]
	 * @return [type]     [description]
	 */
	public function get_no_subcategories_categories()
	{
		$this->db->select('c.name as category,c.id', TRUE);
